            ...
            <div class="border-bottom mb-4 pb-4">
                ...
                <div>
                    <form action="manageBill" method="get">
                        <input type="hidden" name="service" value="filterByCustomerName">
                        <div class="form-group">
                            <label for="customerName">Customer Name:</label>
                            <input type="text" class="form-control" id="customerName" name="customerName" placeholder="Search by name">
                        </div>
