                    ...
                    <table class="table table-bordered text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="date" name="release_date" value="${productUpdate.release_date}" size="8"/>
                                </td>
                            </tr>
                    ...
                    <table class="table table-bordered text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="number" name="price" style="width: 80px" min="1"/>
                                </td>
                                <td class="align-middle">
                                    <input type="number" name="quantity" style="width: 80px" min="1"/>
                                </td>
                                <td class="align-middle">
                                ...
                                <td class="align-middle">
                                    <input type="date" name="release_date" size="8"/>
                                </td>
                            </tr>
